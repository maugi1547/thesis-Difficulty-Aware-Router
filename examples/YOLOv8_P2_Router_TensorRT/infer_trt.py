...
# =============================================================================
def generate_anchors_and_strides(image_size=(640, 640), strides=None, device="cuda"):
    """Membuat anchor points dan stride tensor untuk 4 skala (P2, P3, P4, P5). Total anchors untuk 640x640 = 25600 +
    6400 + 1600 + 400 = 34000.
    """
    if strides is None:
        strides = [4, 8, 16, 32]
    ...
    for s in strides:
        h, w = img_h // s, img_w // s
        # Gunakan indexing='ij' agar sesuai standard YOLOv8
