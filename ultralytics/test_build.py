...
model = YOLO("ultralytics/cfg/models/v8/yolov8x-moe-p2.yaml")
...
model1 = YOLO("ultralytics/cfg/models/v8/yolov8x-p2.yaml")
# Coba print info model
model1.info()
print("BERHASIL! Model yolov8-P2 berhasil dibangun.")

# ngecek summary model yolov8 biasa
model2 = YOLO("ultralytics/cfg/models/v8/yolov8x.yaml")
# Coba print info model
model2.info()
